...
import { OrbitControls } from "https://unpkg.com/three@0.160.0/examples/jsm/controls/OrbitControls.js";
        ...
        function bindCardTap(card, onOpen) {
            // Desktop: normal click. Mobile: only a short stationary tap opens.
            // Do not use pointer capture here: it can steal the gesture from the page
            // and was one cause of creator/project interaction collisions.
            const TAP_MOVE_PX = 12;
            const TAP_TIME_MS = 500;
            let sx = 0, sy = 0, st = 0, moved = false, activePointer = null;
            ...
            card.addEventListener("pointermove", (e) => {
                ...
                if (Math.abs(e.clientX - sx) > TAP_MOVE_PX || Math.abs(e.clientY - sy) > TAP_MOVE_PX) moved = true;
            }, { passive: true });
            ...
            card.addEventListener("pointerup", (e) => {
                ...
                activePointer = null;
                if (moved || dx > TAP_MOVE_PX || dy > TAP_MOVE_PX || dt > TAP_TIME_MS) return;
                if (e.target?.closest?.("button, a, input, textarea, select, [data-no-open]")) return;
                e.stopPropagation();
                onOpen();
            }, { passive: true });

            card.addEventListener("pointercancel", () => { activePointer = null; }, { passive: true });
        }
